...
uint16_t g_LcdHeight = LCD_70_HEIGHT;		/* 显示屏分辨率-高度 */
uint16_t g_LcdWidth = LCD_70_WIDTH;			/* 显示屏分辨率-宽度 */



__IO uint16_t s_usTouchX, s_usTouchY;	/* 触摸屏ADC值 */
